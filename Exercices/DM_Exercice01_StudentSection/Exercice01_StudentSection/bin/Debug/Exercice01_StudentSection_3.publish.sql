...
GO
PRINT N'Création de [dbo].[FK_Student_ToTable]...';


GO
ALTER TABLE [dbo].[Student]
    ADD CONSTRAINT [FK_Student_ToTable] FOREIGN KEY ([SectionID]) REFERENCES [dbo].[Section] ([Id]);
...
GO
PRINT N'Création de [dbo].[CK_Student_BirthDate_1930]...';


GO
ALTER TABLE [dbo].[Student]
    ADD CONSTRAINT [CK_Student_BirthDate_1930] CHECK (BirthDate >= '1930-01-01');
...
AS
	insert into Section (Id, SectionName) values (@sectionID, @sectionName)
